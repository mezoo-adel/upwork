...
window.addEventListener('load', function () {
    ...
    navItem2[0].onclick = function () {
        ...
        // $("navItem2 +section p").textContent = navItem1[0];
        for (let index = 0; index < navItem1.length / 2; index++) {
            navItem2[0].parentElement.parentElement.nextElementSibling.children[index].innerText = navItem1[index];
        }
        for (let index = navItem1.length / 2; index < navItem1.length; index++) {
            navItem2[0].parentElement.parentElement.nextElementSibling.nextElementSibling.children[index - (navItem1.length / 2)].innerText = navItem1[index];
        }
    }
    navItem2[1].onclick = function () {
        ...
        console.log("clicked" + navItem2[1]);
        // $("navItem2 +section p").textContent = navItem1[0];
        for (let index = 0; index < navItem1.length / 2; index++) {
            navItem2[1].parentElement.parentElement.nextElementSibling.children[index].innerText = navItem1[index];
        }
        for (let index = navItem1.length / 2; index < navItem1.length; index++) {
            navItem2[1].parentElement.parentElement.nextElementSibling.nextElementSibling.children[index - (navItem1.length / 2)].innerText = navItem1[index];
        }
    }
    navItem2[2].onclick = function () {
        ...
        console.log("clicked" + navItem2[2]);
        // $("navItem2 +section p").textContent = navItem1[0];
        for (let index = 0; index < navItem1.length / 2; index++) {
            navItem2[2].parentElement.parentElement.nextElementSibling.children[index].innerText = navItem1[index];
        }
        for (let index = navItem1.length / 2; index < navItem1.length; index++) {
            navItem2[2].parentElement.parentElement.nextElementSibling.nextElementSibling.children[index - (navItem1.length / 2)].innerText = navItem1[index];
        }
    }
    navItem2[3].onclick = function () {
        ...
        console.log("clicked" + navItem2[3]);
        // $("navItem2 +section p").textContent = navItem1[3];
        for (let index = 0; index < navItem1.length / 2; index++) {
            navItem2[3].parentElement.parentElement.nextElementSibling.children[index].innerText = navItem1[index];
        }
        for (let index = navItem1.length / 2; index < navItem1.length; index++) {
            navItem2[3].parentElement.parentElement.nextElementSibling.nextElementSibling.children[index - (navItem1.length / 2)].innerText = navItem1[index];
        }
    }
